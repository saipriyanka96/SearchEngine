package com.example.layout.searchengine;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    //(SearchManager.QUERY) is the text to search for. If it is a url starts with http or https, the site will be opened. If it is plain text,
                    ...
                    e.printStackTrace();
                    //if try block is not working then we will use this.
